export default function Home() {
  return (
    <main className="bg-black h-screen flex-row p-8">
      <div className="h-32 bg-white w-5/6 border-gray-500 border-2 rounded-lg p-4 m-4">
      ...
      <div className="h-32 bg-white w-5/6 border-gray-500 border-2 rounded-lg p-4 m-4 my-24">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight">
